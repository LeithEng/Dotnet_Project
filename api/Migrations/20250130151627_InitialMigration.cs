        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentHobbyId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Hobby_Level", "[Level] BETWEEN 1 AND 3");
                    table.ForeignKey(
                        name: "FK_Hobbies_Hobbies_ParentHobbyId",
                        column: x => x.ParentHobbyId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFriendship", x => new { x.FriendId, x.UserId });
                    table.ForeignKey(
